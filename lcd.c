...
void lcd_init(void)
{
    ...
    DDRB |= (1 << PB1) | (1 << PB0);                // Use lcd_writenibble to send 0b0011, no delay needed
...
void lcd_writedata(unsigned char dat)
{
    ...
    lcd_writenibble(dat); //sends upper four bits

    /* Call lcd_writenibble to send LOWER four bits of "dat" argument */

    lcd_writenibble(dat << 4); //sends lower four bits
...
void lcd_writenibble(unsigned char lcdbits)
{
    ...
    /*May need to include a shorter delay*/
