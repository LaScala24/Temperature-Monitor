...
OBJECTS    = project.o lcd.o adc.o ds18b20.o encoder.o serial.o timers.o
...
project.o:   project.c project.h lcd.h ds18b20.h encoder.h timers.h serial.h #from writeup-Did all 4 c files for simplicity
